var seoData = {
  ...
  postSubmit: {
    ...
    description: "Submit a petition to RPI Petitions."
  },
  postsInProgress: {
  ...
  postsList: {
    title: "Petitions",
    description: "RPI Petitions is a place for sparking change at RIT. Share ideas with the RIT community and influence decision making."
  },
  postsResponses: {
  ...
  postsTagList: {
    ...
    description: "View tagged petitions on RPI Petitions."
  },
  postPage: {
    title: "View Petition",
    description: "View petition on RPI Petitions."
  },
  postEdit: {
    title: "Edit Petition",
  ...
  about: {
    title: "About RPI Petitions",
    description: "Learn more about the history of RPI Petitions, its goal and vision."
  },
  api: {
    title: "API Access",
  ...
  moderation: {
    ...
    description: "RPI Petitions follows the RIT Code of Conduct for Computer and Network Use."
  },
  petitionProcess: {
